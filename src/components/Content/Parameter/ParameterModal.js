...
import { addParameter } from "../../../actions/parameterActions";
...
class ParameterModal extends Component {
  ...
  onChange = e => {
    ...
    if (!isPassed)
      msg =
        "Name of parameter can only contain only letters, numbers, underscores and spaces";
  ...
  onSubmit = e => {
    ...
    this.props.addParameter(newItem);
    this.setState({ name: "" });
    // Close modal
...
export default connect(mapStateToProps, { addParameter })(ParameterModal);
